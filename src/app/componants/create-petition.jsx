...
export default function IndexMarketing() {
    ...
    return (
        <>
            <MarketingNavbar />
            <section className="bg-half-170 d-flex flex-column align-items-center"  style={{minHeight:'70vh',paddingBottom:'4rem'}} id="home">
                <Fade damping={0.7} triggerOnce direction="down" className="container align-items-center" style={{height:'100%'}} >
                    <div className="row" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                        <div className="col-12 col-md-12 col-lg-12 blue-pink-gradient" style={{ position: 'relative', display: 'inline-block' }}>
