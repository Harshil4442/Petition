...
export default function IndexMarketing() {
    ...
    return (
        <>
            ...
            <section className="bg-half-170 d-flex align-items-center"  style={{background:'linear-gradient(138deg, rgba(177,221,255,1) 19%, rgba(232,185,255,0.9557948179271709) 38%, rgba(255,170,247,1) 62%, rgba(253,201,255,0.9277836134453782) 96%)'}} id="home">
