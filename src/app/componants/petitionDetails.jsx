                                    ...
                                    <div className="card features feature-primary feature-clean feature-transition p-4 py-5 border-0 shadow rounded-lg overflow-hidden" style={{
                                        ...
                                        margin:'-1.3rem'
                                            ...
                                            <div className="content mt-4" style={{padding:'0.2rem', lineHeight:'1.6rem'}}>
                                                <Fade damping={0.7} triggerOnce direction="down"><h4>Title:  {petition.title}</h4></Fade>
                                                <Fade damping={0.7} triggerOnce direction="down"><p style={{fontSize:'1.1rem', marginTop:'1rem'}}>{petition.municipality}</p></Fade>
                                                <Fade damping={0.7} triggerOnce direction="up"><div style={{marginTop:'2.5rem'}}><b>Description<br/></b> <p style={{padding:'6px',borderRadius:'0.4rem',backgroundColor:'white',boxShadow:'0px 0px 2px 1px rgba(0, 0, 0, 0.07),inset 0px 0px 10px 1px rgba(0, 0, 0, 0.07)'}} className="text-muted mt-3">{petition.description}</p></div></Fade>
                                                <Fade damping={0.7} triggerOnce direction="up"><div style={{marginTop:'2.5rem'}}><b>Category<br/></b><p style={{padding:'6px',borderRadius:'0.4rem',backgroundColor:'white',boxShadow:'0px 0px 2px 1px rgba(0, 0, 0, 0.07),inset 0px 0px 10px 1px rgba(0, 0, 0, 0.07)'}} className="text-muted mt-3">{petition.category}</p></div></Fade>
                                                <Fade damping={0.7} triggerOnce direction="up"><div style={{marginTop:'2.5rem'}}><b>Name<br/></b> <p style={{padding:'6px',borderRadius:'0.4rem',backgroundColor:'white',boxShadow:'0px 0px 2px 1px rgba(0, 0, 0, 0.07),inset 0px 0px 10px 1px rgba(0, 0, 0, 0.07)'}} className="text-muted mt-3">{petition.name}</p></div></Fade>
                                                <Fade damping={0.7} triggerOnce direction="up"><div style={{marginTop:'2.5rem'}}><b>Address<br/></b> <p style={{padding:'6px',borderRadius:'0.4rem',backgroundColor:'white',boxShadow:'0px 0px 2px 1px rgba(0, 0, 0, 0.07),inset 0px 0px 10px 1px rgba(0, 0, 0, 0.07)'}} className="text-muted mt-3">{petition.address}</p></div></Fade>
                                                <Fade damping={0.7} triggerOnce direction="up"><div style={{marginTop:'2.5rem'}}><b>Contact No.<br/></b><p style={{padding:'6px',borderRadius:'0.4rem',backgroundColor:'white',boxShadow:'0px 0px 2px 1px rgba(0, 0, 0, 0.07),inset 0px 0px 10px 1px rgba(0, 0, 0, 0.07)'}} className="text-muted mt-3">{petition.contact}</p></div></Fade>
                                                <Fade damping={0.7} triggerOnce direction="up"><div style={{marginTop:'2.5rem'}}><b>Email ID<br/></b> <p style={{padding:'6px',borderRadius:'0.4rem',backgroundColor:'white',boxShadow:'0px 0px 2px 1px rgba(0, 0, 0, 0.07),inset 0px 0px 10px 1px rgba(0, 0, 0, 0.07)'}} className="text-muted mt-3">{petition.email}</p></div></Fade>
                                            </div>
